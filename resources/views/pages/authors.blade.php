...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row-reverse align-items-center justify-content-between">
            <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#addNewAuthor">
                <i class="fas fa-user-plus"></i> Add New Author
            </button>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="authors" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
